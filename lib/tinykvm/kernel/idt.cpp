...
unsigned char interrupts[] = {
  0x3d, 0x9e, 0x00, 0x00, 0x00, 0x74, 0x0f, 0x05, 0x00, 0xa0, 0xff, 0xff,
  0x67, 0xc7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x48, 0x0f, 0x07, 0x51, 0xb9,
  0x00, 0x01, 0x00, 0xc0, 0x89, 0xf0, 0x31, 0xd2, 0x0f, 0x30, 0x59, 0x48,
  0x31, 0xc0, 0x48, 0x0f, 0x07, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90,
  0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90,
  0x90, 0x90, 0x90, 0x90, 0xff, 0x34, 0x24, 0x66, 0xb8, 0x00, 0x00, 0x66,
...
#define EXCEPTION_HANDLER_OFFS   64
	...
	uint64_t addr, void* area, uint64_t except_addr, void* except_area)
{
	...
	uint64_t offset = except_addr + EXCEPTION_HANDLER_OFFS;
	for (int i = 0; i <= 20; i++) {
		if (i == 15) continue;
