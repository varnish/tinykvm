...
musl-gcc -static -O2 -DSTORAGE=1 -Wl,-Ttext-segment=0x44000000 $WARN -I$NIM_LIBS main.c storage_nimcache/*.c -o storage
...
musl-gcc -static -O2 -Wl,--just-symbols=storage.syms $WARN -I$NIM_LIBS main.c main_nimcache/*.c -o main
